...
import { mdiBallotOutline,mdiPhone, mdiAccount,mdiAsterisk, mdiMail, mdiGithub ,mdiAccountPlus,  mdiAccountMultiple
} from "@mdi/js";
 ...
 />
      ...
      <div v-for="(field, i) of Object.keys(errors)" :key="i">
        <div v-for="(error, ind) of errors[field] || []" :key="ind">
         ...
         <FormField label="Personal Information">
          <FormControl v-model="model.name" :icon="mdiAccount"  placeholder="First name" />
          <FormControl v-model="model.email" type="email" :icon="mdiMail" autocomplete="off" placeholder="Email address" />
      ...
      <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <FormField label="Personal Information" v-if="route.params.id">
          <FormControl v-model="model.password" :icon="mdiAsterisk" type="password" autocomplete="off"  placeholder=" Enter password" />
          <FormControl v-model="model.password_confirmation" type="password" :icon="mdiAsterisk" placeholder="Enter password again" />
        ...
        <!-- Status -->
          ...
          <!--/ Status -->
            <!-- Status -->
          <div v-if="user.is_super_admin === 1"  class="flex items-start">
            <div class="flex items-center h-5">
              <input
                 id="status"
                name="status"
          ...
          <!--/ Status -->
      <!-- Status -->
         <div v-if="user.is_super_admin === 1" class="flex items-start mt-6">
          <div class="flex items-center h-5">
            <input
              id="is_super_admin"
              name="is_super_admin"
