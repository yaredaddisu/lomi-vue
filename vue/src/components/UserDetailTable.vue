...
const loading = computed(() => store.state.currentUser.loading);
...
if(this.isCheckAll){ // Check all
  for (var key in this.model.plan) {
    this.checked.push(this.model.plan[key]);
  }
}
};
function updateCheckall(){
if(this.checked.length == this.model.plan.length){
  ...
  />
   ...
   <CardBox  >
    <div  class="lg:flex lg:flex-col-4 grid grid-cols-2 mb-20 items-center   bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
      ...
      <img class="object-cover w-192 rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" :src="model.image_url" alt="">
        ...
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                <th scope="col" class="p-4">
                    <div class="flex items-center">
                        ...
                        <input id="checkbox-all-search" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" @click='checkAll()' v-model='isCheckAll'>
         ...
         <tbody   >
            ...
            v-for="item in model.plan" :key="item.id">
                ...
                <td class="w-4 p-4">
                    <div class="flex items-center">
                        <input type='checkbox' :value='item' v-model='checked' @change='updateCheckall()' id="checkbox-table-search-1"   class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="px-6 py-4" v-for="question in item.questions  "  :key="question">
